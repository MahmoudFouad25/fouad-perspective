...
(function () {
  ...
  function waMessage(r) {
    ...
    return [
      ...
      '',
      'ومن الحكمة فعلاً إتخاذ قرار التحول "من الانزلاق في الاحتراق إلى استعادة الاتّزان".',
      '',
      'من خلال الاختبار التشخيصيّ الأولي السريع اللي عملته في الويبينار — ظهر إن طريقة استنزافك الرئيسية الأقرب لك إنت تحديدًا.',
      '',
      `تأتي عبر محور: *${axisName}*`,
      '',
      'جهّزتلك في الرابط التالي تقرير مختصر وبسيط خاص بك أنت يشمل: (المحور + الأبعاد التلاتة + وجه الفطرة والقناع + خطوة عمليّة تساعدك خلال الأسبوع الجاي):',
      url,
      '',
      ...
      '',
      'تابعي تفاصيل اللقاء الجاي واللي هيكون يوم الأحد 17 مايو من هنا:',
      CONFIG.groupUrl,
      '',
      'وده تسجيل اللقاء الأوّل (لو حابب تشوفه أو تشاركه مع حدّ حاب إنه يحضر اللقاء الجاي.. وكمان ممكن تقوله ينضم للجروب):',
