...
const PRICES = {
  'part1':         { base: 2400, name: 'الجزء الأول مسجَّل',           sub: 'اكتشاف المعجزة' },
  'full':          { base: 4200, name: 'الباقة الكاملة',                sub: 'اكتشاف + احتضان المعجزة' },
  'part2-alumni':  { base: 2800, name: 'الجزء الثاني · للمجموعة السابقة', sub: 'احتضان المعجزة' }
};
